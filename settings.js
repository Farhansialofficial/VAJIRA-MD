...
global.owner = process.env.OWNER_NUMBER  || '923342424026' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=bUsFBajC#DdvR0r_CRf9EyQE3di2f0ohKzYG3teriCrAYqFiG13Q' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "923342424026,94787820101" : process.env.MODERATORS ,    
